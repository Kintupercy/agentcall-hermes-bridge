...
109 more cover the consumer and the Hermes adapter, most of them on the ack decision — the one that loses a text if it acks too early and double-texts a human if it acks too late. See [consumer/README.md](consumer/README.md#tests).
